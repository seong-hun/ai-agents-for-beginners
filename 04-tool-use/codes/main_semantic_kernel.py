...
async def main():
    async with (
        ...
        AzureAIAgent.create_client(
            ...
            endpoint="https://modulabs-ai-agent-lab-s2-resourc.services.ai.azure.com/api/projects/modulabs-ai-agent-lab-s2",
        ) as client,
    ):
        ...
        agent = AzureAIAgent(
            client=client, definition=agent_definition, plugins=[BookingPlugin()]
        )
